use bevy::prelude::*;
use bevy::ui::{VisualBox, widget::NodeImageMode};
...
impl Plugin for ObjectivesPanelPlugin {
    fn build(&self, app: &mut App) {
        app
            ...
            .add_observer(ObjectivesPanel::on_objective_added_attach_to_panel)
            .add_observer(ObjectivesPanel::on_add_construct_objectives_panel)
...
impl ObjectivesPanel {
    ...
    fn on_objective_added_attach_to_panel(
